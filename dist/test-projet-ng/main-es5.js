...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RegisterComponent = /** @class */ (function () {
                ...
                RegisterComponent.prototype.resetForm = function (formDir) {
                    formDir.reset();
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                function UserService(auth, resource, httpClient) {
                    this.auth = auth;
                ...
                UserService.prototype.authenticate = function (email, password) {
                    var _this = this;
                    var body = { email: email, password: password };
                    return this.httpClient.post(this.uri + "/api/auth/users", body).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(_User__WEBPACK_IMPORTED_MODULE_6__["User"].NEW), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (user) {
                        console.log(user);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var UserShape = /** @class */ (function () {
                function UserShape(data) {
                    this.id = data.id;
                ...
                UserShape.NEW = function (data) {
                    return new UserShape(data);
                };
                UserShape.NEW_BUNCH = function (data) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserResourceService = /** @class */ (function () {
                function UserResourceService(httpClient) {
                    this.httpClient = httpClient;
                    this.resourcePath = 'https://apibarcocktail.herokuapp.com/api/users';
                }
                UserResourceService.prototype.user = function (userId) {
                    console.log('user');
                ...
                UserResourceService.prototype.updateUser = function (userId, data) {
                ...
                UserResourceService.prototype.requestUser = function (userId) {
                    var URL = this.resourcePath + "/" + userId;
                    return this.httpClient.get(URL);
                };
                UserResourceService.prototype.patchUser = function (userId, data) {
                    var URL = this.resourcePath + "/" + userId;
